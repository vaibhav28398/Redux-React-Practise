    ...
    render(){
        ...
        return(
            <div>
                ...
                <button onClick={()=>this.props.action_creator1()}>Dispatch Action craetor 1</button>
                <button onClick={()=>this.props.action_creator2()}>Dispatch Action craetor 2</button>
                <button onClick={()=>this.props.action_creator3(text)}>Dispatch Action craetor 3</button>
